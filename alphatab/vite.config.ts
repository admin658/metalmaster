    ...
    if (command === 'serve') {
        ...
        switch (mode) {
            ...
            case 'esm': {
                ...
                libEntry['alphaTab.core'] = path.resolve(__dirname, 'src/alphaTab.core.ts');
                libEntry['alphaTab.worker'] = path.resolve(__dirname, 'src/alphaTab.worker.ts');
                libEntry['alphaTab.worklet'] = path.resolve(__dirname, 'src/alphaTab.worklet.ts');
